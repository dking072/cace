...
from cace.modules import Atomwise, DirectForces
...
direct_forces = DirectForces(forces_key="pred_force")

model = NeuralNetworkPotential(
    input_modules=None,
    representation=representation,
    output_modules=[atomwise, direct_forces]
)
