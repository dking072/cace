#!/usr/bin/env python
# coding: utf-8
"""CACE + LES with the full multipole set: dipoles, induced charges (kappa),
induced dipoles (alpha), and quadrupoles.

Variant of ``caceles-uiuQ-dipep.py`` that additionally enables the kappa
charge-induction channel by passing ``kappa_key='kappas'`` to LesWrapper.
"""
...
logs_name = "caceles_uiuiqQ_dipep"
...
# ---------------------------------------------------------------------------
# Output modules — full multipole set + kappa charge induction
# ---------------------------------------------------------------------------
