#!/usr/bin/env python
# coding: utf-8
"""CACE + LES with charges only — no atomic dipoles, no quadrupoles.

Variant of ``caceles-uiuQ-dipep.py``. The TensorReadout is dropped entirely;
LES predicts per-atom latent charges from the scalar node features and uses
only those in the Ewald sum. This is the most minimal LES model.
"""
...
logs_name = "caceles_dipep"

# ---------------------------------------------------------------------------
# Representation — only scalar features needed (LES learns charges from them)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Output modules — charges only (no TensorReadout)
# ---------------------------------------------------------------------------
les_e = LesWrapper(
