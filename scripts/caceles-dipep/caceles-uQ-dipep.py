#!/usr/bin/env python
# coding: utf-8
"""CACE + LES with permanent dipoles + quadrupoles only (no induction).

Variant of ``caceles-uiuQ-dipep.py``. TensorReadout emits per-atom kappas
(latent — unused), dipoles, and quadrupoles. LesWrapper consumes only the
permanent dipoles and quadrupoles — no alpha (no induced dipoles), no kappa
(no induced charges).
"""
...
logs_name = "caceles_uQ_dipep"

# ---------------------------------------------------------------------------
# Representation — l<=2 for the quadrupole tensor
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Output modules — permanent dipoles + quadrupoles only
# ---------------------------------------------------------------------------
