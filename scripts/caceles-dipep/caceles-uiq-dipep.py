#!/usr/bin/env python
# coding: utf-8
"""CACE + LES with permanent dipoles + induced charges (kappa).

Variant of ``caceles-uiuQ-dipep.py``. TensorReadout emits per-atom kappas
and per-atom dipoles; LesWrapper consumes both (kappa drives induced charges
via the Ewald field). No alpha (no induced dipoles), no quadrupole.
"""
...
logs_name = "caceles_uiq_dipep"

# ---------------------------------------------------------------------------
# Representation — l<=1 outputs (scalar kappas, vector dipoles)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Output modules — permanent dipoles + induced charges (kappa)
# ---------------------------------------------------------------------------
