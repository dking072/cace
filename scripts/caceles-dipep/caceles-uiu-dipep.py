#!/usr/bin/env python
# coding: utf-8
"""CACE + LES with permanent + induced atomic dipoles (no quadrupoles).

Variant of ``caceles-uiuQ-dipep.py``. The TensorReadout emits per-atom
charges (kappas, latent — unused by LES), per-atom dipoles, and per-atom
polarisabilities (alpha). LesWrapper consumes charges, permanent dipoles,
and uses alpha to add induced dipoles. No quadrupole.
"""
...
logs_name = "caceles_uiu_dipep"

# ---------------------------------------------------------------------------
# Representation — need l<=2 for the alpha tensor
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Output modules — permanent + induced dipoles (alpha), no quadrupoles
# ---------------------------------------------------------------------------
